...
//get player class from export in player.js
var Player = require('./player.js').Player;
var Waypoint = require('./waypoint.js').Waypoint;
var Bullet = require('./player.js').Bullet;
...
setInterval(function () { // bullet update
...
io.on('connection', function (socket) {
  ...
  socket.on('mouseclick', function (data) {
    if (start) { //TEMP
      ...
      if (data.left == true && waitingplayers[socket.id]) {
